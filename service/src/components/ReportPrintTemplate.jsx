  ...
  return (
    <>
      <div style={styles.form1TopBrandRow}>
        <img src="/service-assets/img/Logo.jpg" alt="Logo" style={styles.form1Logo} />
        <div style={styles.form1QrWrap}>
          <div style={styles.originalLabel}>ต้นฉบับ</div>
          <img src="/service-assets/img/qrline.jpg" alt="QR Code" style={styles.form1QrCode} />
        </div>
      </div>
  ...
  return (
    <>
      <div style={styles.topBrandRow}>
        <img src="/service-assets/img/Logo.jpg" alt="Logo" style={styles.logo} />
        <div style={styles.qrWrap}>
          <div style={styles.originalLabel}>ต้นฉบับ</div>
          <img src="/service-assets/img/qrline.jpg" alt="QR Code" style={styles.qrCode} />
        </div>
      </div>
